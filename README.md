...
1. * Valid codes - All the valid customer codes (comma separated) for the Registration Form.
2. * Single usage codes - Click checkbox if the Customer Codes only can be used one time.
3. * Account page - Click checkbox for Customer Code display in view mode on the user Account page.
